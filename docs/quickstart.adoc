...
The current latest version is *1.0.0-beta.2*.
...
There are a couple ways you can get access to `cbsh`, the easiest one is to download our pre-built binaries for your platform of choice:
 ...
 - Linux: https://github.com/couchbaselabs/couchbase-shell/releases/download/v1.0.0-beta.2/cbsh-1.0.0-beta.2-linux.tar.gz[cbsh-1.0.0-beta.2-linux.tar.gz]
 - macOS: https://github.com/couchbaselabs/couchbase-shell/releases/download/v1.0.0-beta.2/cbsh-1.0.0-beta.2-mac.zip[cbsh-1.0.0-beta.2-mac.zip]
 - Windows: https://github.com/couchbaselabs/couchbase-shell/releases/download/v1.0.0-beta.2/cbsh-1.0.0-beta.2-windows.zip[cbsh-1.0.0-beta.2-windows.zip]
...
```
$ unzip cbsh-1.0.0-beta.2-osx.zip
$ ls
