...
There are a couple ways you can get access to `cbsh`, the easiest one is to download our pre-built binaries for your platform of choice:
 ...
 - Linux: https://github.com/couchbaselabs/couchbase-shell/releases/download/v0.5.0/cbsh-0.4.0-linux.zip[cbsh-0.5.0-linux.zip]
 - macOS: https://github.com/couchbaselabs/couchbase-shell/releases/download/v0.5.0/cbsh-0.4.0-osx.zip[cbsh-0.5.0-osx.zip]
 - Windows: https://github.com/couchbaselabs/couchbase-shell/releases/download/v0.5.0/cbsh-0.4.0-windows.zip[cbsh-0.5.0-windows.zip]
