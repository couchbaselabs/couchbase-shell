...
# key_words are n1ql query keywords, ASC and DESC are excluded as we don't count these as starting a new clause in
# the formatting logic
const $key_words = [FROM SELECT WHERE AND LIMIT ANY EVERY IN SATISFIES END ORDER BY]
